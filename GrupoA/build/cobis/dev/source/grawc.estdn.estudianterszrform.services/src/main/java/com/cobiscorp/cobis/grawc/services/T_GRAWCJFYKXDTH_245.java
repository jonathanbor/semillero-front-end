 ...
 * T_GRAWCJFYKXDTH_245 - EstudianteRszrForm 
 *
 */
@Path("/GRAWC/ESTDN/T_GRAWCJFYKXDTH_245")
@Component
@Service({T_GRAWCJFYKXDTH_245.class})
@References({
@Reference(name="formEventBuilder",
	...
	target="(&(task.module=GRAWC)(task.submodule=ESTDN)(task.id=T_GRAWCJFYKXDTH_245)(task.version=1.0.0))")
,@Reference(name="VW_ESTUDIANEE_284", 
	referenceInterface=ViewEventBuilder.class, 
	bind = "addViewEventBuilder", 
	unbind = "removeViewEventBuilder",
	cardinality = ReferenceCardinality.OPTIONAL_MULTIPLE, 
	policy=ReferencePolicy.DYNAMIC,
	target="(&(view.id=VW_ESTUDIANEE_284)(view.version=1.0.0))")
...
public class T_GRAWCJFYKXDTH_245 {
