...
function VC_ESTUDIANZE_388245(cobisMainModule) {
    ...
    cobisMainModule.controllerProvider.register("VC_ESTUDIANZE_388245_CTRL", ["cobisMessage", cobis.modules.CONTAINER + ".preferencesService", "dsgnrUtils", "designer", "$scope", "$location", "$document", "$parse", "$filter", "$modal", "$q", "$compile", "$timeout", "$translate",
    ...
    function(cobisMessage, preferencesService, dsgnrUtils, designer, $scope, $location, $document, $parse, $filter, $modal, $q, $compile, $timeout, $translate) {
        ...
        $scope.vc = designer.initViewContainer({
            ...
            "${contextPath}/resources/GRAWC/ESTDN/T_GRAWCJFYKXDTH_245",
        ...
        if (!$scope.vc.loaded) {
            ...
            $scope.vc.createViewState({
                ...
                componentStyle: [],
                label: "GRAWC.LBL_GRAWC_APELLIDOO_48891",
                validationCode: 0,
                readOnly: designer.constants.mode.Query,
                enabled: designer.constants.mode.All,
                visible: designer.constants.mode.All
            ...
            $scope.vc.createViewState({
                ...
                componentStyle: [],
                label: "GRAWC.LBL_GRAWC_GUARDARJV_15251",
                validationCode: 0,
...
if (typeof cobisMainModule === "undefined") {
    var cobisMainModule = cobis.createModule("VC_ESTUDIANZE_388245", ["ngResource", "ngRoute", "kendo.directives", "ui.bootstrap", "oc.lazyLoad", "pascalprecht.translate", cobis.modules.CONTAINER, "designerModule"], ["DSGNR", "GRAWC"]);
