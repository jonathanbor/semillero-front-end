/*
 * Archivo: T_GRAWCXHEJXDEQ_234.java
 * Fecha: 2021-08-11T17:25:56Z
 *
 ...
 * T_GRAWCXHEJXDEQ_234 - EstudianteJibyForm 
 *
 */
@Path("/GRAWC/ESTDN/T_GRAWCXHEJXDEQ_234")
@Component
@Service({T_GRAWCXHEJXDEQ_234.class})
@References({
@Reference(name="formEventBuilder",
	...
	target="(&(task.module=GRAWC)(task.submodule=ESTDN)(task.id=T_GRAWCXHEJXDEQ_234)(task.version=1.0.0))")
,@Reference(name="VW_ESTUDIANBB_241", 
	referenceInterface=ViewEventBuilder.class, 
	bind = "addViewEventBuilder", 
	unbind = "removeViewEventBuilder",
	cardinality = ReferenceCardinality.OPTIONAL_MULTIPLE, 
	policy=ReferencePolicy.DYNAMIC,
	target="(&(view.id=VW_ESTUDIANBB_241)(view.version=1.0.0))")
...
public class T_GRAWCXHEJXDEQ_234 {
