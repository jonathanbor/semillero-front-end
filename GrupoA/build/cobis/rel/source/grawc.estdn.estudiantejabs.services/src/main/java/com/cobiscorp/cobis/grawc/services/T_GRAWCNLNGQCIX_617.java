/*
 * Archivo: T_GRAWCNLNGQCIX_617.java
 * Fecha: 2021-08-11T17:25:55Z
 *
 ...
 * T_GRAWCNLNGQCIX_617 - EstudianteJabs 
 *
 */
@Path("/GRAWC/ESTDN/T_GRAWCNLNGQCIX_617")
@Component
@Service({T_GRAWCNLNGQCIX_617.class})
@References({
@Reference(name="formEventBuilder",
	...
	target="(&(task.module=GRAWC)(task.submodule=ESTDN)(task.id=T_GRAWCNLNGQCIX_617)(task.version=1.0.0))")
,@Reference(name="VW_ESTUDIANSJ_831", 
	referenceInterface=ViewEventBuilder.class, 
	bind = "addViewEventBuilder", 
	unbind = "removeViewEventBuilder",
	cardinality = ReferenceCardinality.OPTIONAL_MULTIPLE, 
	policy=ReferencePolicy.DYNAMIC,
	target="(&(view.id=VW_ESTUDIANSJ_831)(view.version=1.0.0))")
...
public class T_GRAWCNLNGQCIX_617 {
