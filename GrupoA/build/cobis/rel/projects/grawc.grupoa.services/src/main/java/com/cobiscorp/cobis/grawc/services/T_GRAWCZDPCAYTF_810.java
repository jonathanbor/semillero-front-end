 ...
 * T_GRAWCZDPCAYTF_810 - EstudianteJshForm 
 *
 */
@Path("/GRAWC/ESTDN/T_GRAWCZDPCAYTF_810")
@Component
@Service({T_GRAWCZDPCAYTF_810.class})
@References({
@Reference(name="formEventBuilder",
	...
	target="(&(task.module=GRAWC)(task.submodule=ESTDN)(task.id=T_GRAWCZDPCAYTF_810)(task.version=1.0.0))")
,@Reference(name="VW_ESTUDIANSE_999", 
	referenceInterface=ViewEventBuilder.class, 
	bind = "addViewEventBuilder", 
	unbind = "removeViewEventBuilder",
	cardinality = ReferenceCardinality.OPTIONAL_MULTIPLE, 
	policy=ReferencePolicy.DYNAMIC,
	target="(&(view.id=VW_ESTUDIANSE_999)(view.version=1.0.0))")
...
public class T_GRAWCZDPCAYTF_810 {
